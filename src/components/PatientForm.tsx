...
export default function PatientForm() {
    ...
    const addPatient = usePatientStore(store => store.addPatient);
    const activeId = usePatientStore(store => store.activeId);
    const patients = usePatientStore(store => store.patients);
    const updatePatient = usePatientStore(store => store.updatePatient);
            ...
            >
                ...
                <div className="mb-5">
                    ...
                    <input
                        ...
                        type="date"
                        {...register('date', {
                            required: 'La fecha de alta es es obligatorio'
                        })}
                    />
